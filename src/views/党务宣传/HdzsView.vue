<template>
  <div id="base" class="">
    <HeaderTab text="党组织活动展示"></HeaderTab>
    ...
    <div class="breadCrumb">
      ...
      <div class="tool">
        <el-breadcrumb separator="/">
          ...
          >
          <el-breadcrumb-item
            ><router-link to="/dwxc">党务宣传</router-link></el-breadcrumb-item
          >
          <el-breadcrumb-item>党组织活动展示</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
    </div>
    ...
    <div class="list_left">
      ...
      <div class="imgcenter">
        <ul>
          <li>
            <router-link to="/dwxc">党务政策宣传</router-link>
          </li>
    ...
    <div id="u122" class="ax_default line">
      <img id="u122_img" class="img" src="@/assets/images/党务宣传/u122.svg" />
      <div
        id="u122_text"
        class="text"
    ...
    <div class="newsList">
      <div class="dyw981_act">
        <ul class="dyw981_text">
          <li class="text" v-for="items in newsArr" :key="items.index">
    ...
    <!-- Unnamed (图片 ) -->
    <div id="u116" class="ax_default _图片_">
      <FooterTab></FooterTab>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      newsArr: [
        {
          content: "新时代十年党内集中教育创新发展和经验总结",
          date: "2023-09-02",
        },
        {
          content: "深刻认识和把握“六个必须坚持”的立场观点方法",
          date: "2023-08-15",
        },
        {
          content: "如何高质量开展主题教育 系列问答 经验案例学习研讨",
          date: "2023-07-11",
        },
        {
          content: "感悟思想伟力 交出优异答卷",
          date: "2023-07-02",
        },
        {
          content: "坚持正确用人导向 努力营造干事创业良好氛围",
          date: "2023-06-12",
        },
        {
          content: "四次调研四堂党课，总书记指导主题教育深入开展",
          date: "2023-06-01",
        },
        {
          content: "深入开展主题教育 这几种书是重要学习材料",
          date: "2023-05-18",
        },
        {
          content: "中卫健全培养选拔优秀年轻干部工作机制",
          date: "2023-05-16",
        },
        {
          content: "中卫市激励优秀年轻干部勇站“C位”",
          date: "2023-04-19",
        },
        {
          content: "第十三届中国旅游产业博览会在津开幕”",
          date: "2023-04-10",
        },
      ],
    };
