...
export default {
  ...
  beforeMount() {
    this.getNewArr(this.dyxxType, this.pageNum, this.pageSize, this.orderByColumn, this.isAsc);
  },
  methods: {
    ...
    handleCurrentChange(val) {
      ...
      this.getNewArr(this.dyxxType, val, this.pageSize, this.orderByColumn, this.isAsc);
